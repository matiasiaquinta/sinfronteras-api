...
router.get("/stats", auth, getAlumnosStats);

// Ruta para mostrar pagos en Reportes
router.get("/pagos", auth, getAlumnosPagos);

//validateSchema -> es para detectar errores.
router.post("/", auth, validateSchema(createAlumnoSchema), createAlumno);
//router.put("/alumnos", auth, validateSchema(createAlumnoSchema), updateAlumno);
//router.post("/alumnos", auth, createAlumno);

router.get("/:id", auth, getAlumno);

router.put("/:id", auth, validateSchema(editAlumnoSchema), updateAlumno);
